...
const TerminalPreview: React.FC<TerminalPreviewProps> = ({ modules, theme }) => {
  return (
    <div 
    ...
    >
      ...
      >
        ...
        <div className="ml-2 text-xs select-none opacity-50" style={{ color: theme.colors.gray }}>user@machine: ~</div>
      </div>
      ...
      <div className="p-6 min-h-[120px]">
        ...
        <div className="flex flex-wrap items-center font-medium leading-snug">
          {modules.filter(m => !m.disabled).map((mod, idx) => {
